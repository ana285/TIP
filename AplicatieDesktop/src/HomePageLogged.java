...
public class HomePageLogged extends javax.swing.JFrame {

    /**
     * Creates new form HomePageLogged
     */
    public HomePageLogged() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomePageLogged.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
