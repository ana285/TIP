...
<body onload="tabelXML('xml/table.xml')">
			...
			<div class="carousel-inner">
				<div class="item active">
					...
					<div class="carousel-caption">
						...
						<br/>
						<button onclick="location.href='register.jsp'" name="button" class="btn btn-default">Create Account</button> 
					</div>
				</div>
				...
				<div class="item">
					<div class="carousel-caption">
						...
						<h3>
							<a href="#table" style="text-decoration:none; color:white;">29 October 2019</a>
						</h3>
						<br/>
					</div>
	...
	<div class="container text-center">
		<h2 style="font-family: Montsserrat; font-style: italic; font-size: 2.3em;">START THE DAY WITH US!</h2>
		<br/><br/>
		
		<div class="row">
			<div class="col-md-6">
				<img src="images/TraditionalGrecesc.jpg" alt="Traditional Grecesc" class="img-responsive">
			</div>
			
			<div class="col-sm-6">
				<h4 style="text-transform: uppercase;">Chicken Souvlaki with Pita Bread</h4>
				<br/>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h4 style="text-transform: uppercase;">Chorizo and Avocado Breakfast Tacos</h4>
				<br/>
			...
			<div class="col-md-6">
				<img src="images/TraditionalMexican.jpg" alt="Traditional Mexican" class="img-responsive">
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<!-- SPECIFIC ITALIAN -->
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<img src="images/TraditionalItalian.jpg" alt="Traditional Italian" class="img-responsive">
			</div>

			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<h4 style="text-transform: uppercase;">Italian Beef</h4>
				<p>This is a favorite Italian beef recipe , made with a
					pot roast and Italian salad dressing. The pepperoncini adds extra
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<img src="images/StreetFood1.jpg" alt="Street Food Revenue" class="img-responsive">
			</div>
		</div>
	</div>
